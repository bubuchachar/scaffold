...
export const WizardSuccess = ({ boardUrl, boardName, cardsCreated }: WizardSuccessProps) => {
  const [copied, setCopied] = useState(false);

  // No invite failures in MVP - invites are handled in Trello API
  const hasInviteFailures = false;
      ...
      <main className="container mx-auto px-4 pt-24 md:pt-32 flex flex-col items-center">
        ...
        >
          ...
          <p className="font-sans text-[18px] text-[#4a5568] leading-relaxed">
            Everything lives in Trello now. You won't need to come back to Scaffold.
          </p>
        </motion.div>
        ...
        >
          <div className="flex flex-col items-center relative z-10">
            ...
            <p className="font-sans text-[16px] text-[#4a5568] mb-8 max-w-md mx-auto">
              Your board "<strong>{boardName}</strong>" is ready with all phases, cards, and definitions of done.
            </p>
            <Button 
              asChild
            ...
            <div className="mt-6 pt-6 border-t border-[#e2e8f0]">
              <p className="text-[14px] text-[#4a5568] leading-relaxed">
                <span className="font-semibold text-[#1a2332]">💡 Tip:</span> Invite your team first if you haven't, then start with the "Read me first" card.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button 
                onClick={() => {
                  const message = `Hey team, I've set up our Trello board using Scaffold.

Start with the card called "Read me first."

Quick rule: no link = not ready to review.

Board link: [paste Trello link]`;
