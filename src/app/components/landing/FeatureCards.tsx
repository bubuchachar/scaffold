        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, idx) => (
            <Card key={idx} className="p-8 border border-[#e2e8f0] shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.12)] transition-all duration-300 hover:-translate-y-1 bg-white rounded-2xl group">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#8B72FF] to-[#6A4FFF] flex items-center justify-center text-white text-xl font-bold mb-6 group-hover:scale-110 transition-transform duration-300 shadow-[#6A4FFF]/20 shadow-lg">
                {feature.icon}
              </div>
