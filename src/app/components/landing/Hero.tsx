      ...
      <div className="container mx-auto max-w-5xl flex flex-col items-center">
        ...
        >
          <span className="text-white text-xs font-bold tracking-wider uppercase font-['Inter',sans-serif]">
            Workflow Installer for Student Teams
          </span>
        </motion.div>
        ...
        >
          Make your team shippable in 2 minutes
        </motion.h1>
        ...
        >
          Answer 6 questions. We'll install a Trello board with ready-to-run phases, tasks, and "done means done" checklists.
        </motion.p>
