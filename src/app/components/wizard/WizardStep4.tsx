...
const intensities: IntensityOption[] = [
  {
    id: "light",
    title: "Light",
    description: "30% more time per phase. For teams with other commitments or exploring UX methods for the first time."
  },
  {
    id: "standard",
    title: "Standard",
    description: "Balanced timeline. Recommended for most semester projects with typical academic workloads."
  },
  {
    id: "crunch",
    title: "Crunch-Safe",
    description: "30% tighter timeline. For experienced teams or shorter project durations. Still maintains quality gates."
  }
];
      ...
      <main className="flex-1 container mx-auto px-4 flex flex-col items-center justify-center pt-16">
        ...
        >
          ...
          <p className="font-sans text-[16px] text-[#4a5568] leading-relaxed mb-8">
            This affects how we calculate suggested due dates for each phase.
          </p>
